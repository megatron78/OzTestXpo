            ...
            @include('vendor.adminlte.layouts.partials.searchpre')
                ...
                @foreach($instituciones as $institucion)
                    @if($institucion->plan === "1G" || $institucion->plan === "2P")
                        ...
                        @endif
                        {{-- Gold y Premium --}}
                        <div class="col-md-4" onmouseleave="$('#collapse{{ $institucion->id }}').collapse('toggle');">
                            ...
                            <div class="box box-widget widget-user">
                                ...
                                <div class="box-footer">
                                    <h3 style="color:black" class="widget-user-username">{{ str_limit($institucion->nombre_corto, $limit=35, $end="...") }}</h3>
                                    <div class="row">
                                        <div class="col-sm-4 border-right centered">
                                            <div class="description-block">
                                                <h5 class="description-header">Educación</h5>
                                                <span class="description-text"><i class="fa  fa-venus-mars margin-r-5"></i>
                                        ...
                                        <div class="col-sm-4 centered">
                                            <div class="description-block">
                                                ...
                                                <span class="description-text">{{ isset($institucion->city->name) ? $institucion->city->name : "ND" }}, {{ isset($institucion->province->name) ? $institucion->province->name : "ND" }}</span>
                                            </div>
                                            <!-- /.description-block -->
                                        </div>
                                        <!-- /.col -->
                                    ...
                                    <div id="collapse{{ $institucion->id }}" class="panel-collapse collapse">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <i class="fa fa-phone margin-r-5"></i> {{ $institucion->telefono }} / {{ $institucion->celular }} <br>
                                            <i class="fa fa-envelope margin-r-5"></i> {{ $institucion->email }}
                                        </div>
                                        <div class="text-center">
                                            <a href="{{ $institucion->facebook }}" class="btn btn-social-icon btn-facebook"><i class="fa fa-facebook"></i></a>
                                            <a href="{{ $institucion->twitter }}" class="btn btn-social-icon btn-twitter"><i class="fa fa-twitter"></i></a>
                    ...
                    @else
                        ...
                        @endif
                        <div class="col-md-3" onmouseleave="if($('#collapse{{ $institucion->id }}').attr('aria-expanded') === 'true'){ $('#collapse{{ $institucion->id }}').collapse('toggle');}">
                            <div class="box box-primary centered">
                                <div class="box-header with-border bg-gray-active">
                                    <h3 class="box-title"><strong>{{ str_limit($institucion->nombre_corto, $limit=25, $end="...") }}</strong></h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <h5><strong><i class="fa fa-map-marker margin-r-5"></i> Ubicación</strong></h5>

                                    <p class="text-muted">{{ isset($institucion->canton->name) ? $institucion->canton->name : "ND" }}, {{ isset($institucion->province->name) ? $institucion->province->name : "ND" }}</p>
