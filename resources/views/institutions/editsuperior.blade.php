            ...
            <div class="col-md-12 col-md-offset-0">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <br>
                        {{ Form::select('tipo', ['Universidad' => 'Universidad', 'Instituto' => 'Instituto', 'Academia' => 'Academia'], $pregrade->tipo) }}
                        <br>
                        ...
                        <br>
                        {{ Form::number('area_total', $pregrade->area_total) }}
                        <br>
                        {{ Form::label('area_deportiva', 'Área Canchas Deportivas') }}
                        <br>
                        {{ Form::number('area_deportiva', $pregrade->area_deportiva) }}
                        <br>
                        {{ Form::label('area_espacios_verdes', 'Área Espacios Verdes') }}
                        <br>
                        {{ Form::number('area_espacios_verdes', $pregrade->area_espacios_verdes) }}
                        <br>
                        {{ Form::label('area_piscina', 'Área Piscina') }}
                        <br>
                        {{ Form::number('area_piscina', $pregrade->area_piscina) }}
                        <br>
                        ...
                        <br>
                        {{ Form::number('capacidad_restaurantes', $pregrade->capacidad_restaurantes) }}
                        <br>
                        {{ Form::label('canchas_indoor', 'Canchas de Indoor') }}
                        <br>
                        {{ Form::number('canchas_indoor', $pregrade->canchas_indoor) }}
                        <br>
                        {{ Form::label('canchas_futbol', 'Canchas de Fútbol') }}
                        <br>
                        {{ Form::number('canchas_futbol', $pregrade->canchas_futbol) }}
                        <br>
                        {{ Form::label('canchas_basket', 'Canchas de Básquet') }}
                        <br>
                        {{ Form::number('canchas_basket', $pregrade->canchas_basket) }}
                        <br>
                        {{ Form::label('canchas_tenis', 'Canchas de Tenis') }}
                        <br>
                        {{ Form::number('canchas_tenis', $pregrade->canchas_tenis) }}
                        <br>
                        {{ Form::label('mesas_tenis', 'Mesas de Tenis') }}
                        <br>
                        {{ Form::number('mesas_tenis', $pregrade->mesas_tenis) }}
                        <br>
