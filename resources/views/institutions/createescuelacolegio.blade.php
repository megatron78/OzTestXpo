            ...
            <div class="col-md-12 col-md-offset-0">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        {{ Form::select('canton_id', [null=>'...'], ['class' => 'form-control']) }}
                        <br>
                        {{ Form::label('parish_id', 'Parroquia') }}
                        {{ Form::select('parish_id', [null=>'...'], ['class' => 'form-control']) }}
                        <br>
                        {{ Form::label('city_id', 'Ciudad') }}
                        {{ Form::select('city_id', [null=>'...'], ['class' => 'form-control']) }}
                        <br>
                        {{ Form::label('sector_id', 'Sector') }}
                        {{ Form::select('sector_id', [null=>'...'], ['class' => 'form-control']) }}
                        ...
                        <br>
                        {{ Form::number('pago_promedio_escuela', 0) }}
                        <br>
                        {{ Form::label('pago_promedio_colegio', 'Pago Promedio Colegio') }}
                        <br>
                        {{ Form::number('pago_promedio_colegio', 0) }}
                        <br>
                        ...
                        <br>
                        {{ Form::number('edad_desde') }}
                        <br>
                        {{ Form::label('edad_hasta', 'Edad Hasta') }}
                        <br>
                        {{ Form::number('edad_hasta') }}
                        <br>
                        ...
                        <br>
                        {{ Form::number('computadoras_para_alumnos', 0) }}
                        <br>
                        ...
                        <br>
                        {{ Form::select('regimen', ['Costa' => 'Costa', 'Sierra' => 'Sierra', 'Costa y Sierra' => 'Costa y Sierra'], 'Sierra') }}
                        <br>
