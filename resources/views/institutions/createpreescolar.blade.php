                                ...
                                <div class="tab-pane active" id="tab_11">
                                    <div class="col-md-6 col-md-offset-0">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::textarea('trayectoria', null, ['class' => 'form-control', 'PlaceHolder' => 'Los años de experiencia como institución']) }}
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab_22">
                                    <div class="col-md-6 col-md-offset-0">
                                        <div class="form-group">
                                            ...
                                            {{ Form::hidden('laico',0)}}
                                            {{ Form::checkbox('laico', null, true, [ 'class' => 'chkclass', 'onclick' => 'SetSel(this)' ]) }}
                                            &nbsp;&nbsp;
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::hidden('mixto',0)}}
                                            {{ Form::checkbox('mixto', null, true, [ 'class' => 'chkclass2', 'onclick' => 'SetSel2(this)' ]) }}
                                        </div>
                                        <div class="form-group">
                                            ...
                                            {{ Form::checkbox('privado', null, true, [ 'class' => 'chkclass3', 'onclick' => 'SetSel3(this)' ]) }}
                                            &nbsp;&nbsp;
